...
<ul class="nav menu">
			...
			<li class="active"><a href="tambah-kendaraan.php"><em class="fa fa-car">&nbsp;</em>Tipe Kendaraan</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-6">
				<h1 class="page-header">Edit Tipe Kendaraan</h1>
			</div>
		</div><!--/.row-->
				...
				<div class="panel panel-default">
					...
					<div class="panel-body" style="padding-top:3%;">
						...
						<div class="col-md-12">
							...
							<form role="form" method="post" name="editt">


								<div type="hidden" class="form-group">
									<label>ID</label>
									<input class="form-control" name="id_kend" placeholder="Kode" value="<?php echo $a['id_kend']; ?>" readonly>
								</div>

								<div class="form-group">
									<label>Kode Kendaraan</label>
									<input class="form-control" name="kode_kend" placeholder="Kode"value="<?php echo $a['kode_kend']; ?>">
								</div>
								
								<div class="form-group">
									<label>Nama Kendaraan</label>
									<input class="form-control" name="nama_kend" placeholder="Nama Kendaraan" value="<?php echo $a['nama_kend']; ?>">
								</div>

								<div class="form-group">
									<label>Tipe Kendaraan</label>
									<select class="form-control" name="tipe_kend">
											<option><?php echo $a['tipe_kend']; ?></option>
											<option>Mesin</option>
										...
										<div class="form-group">
										<input type="submit" name="editt" class="btn btn-lg btn-primary " value="Edit Data">
										</div>
