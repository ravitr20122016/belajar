...
<?php
	...
	ob_start();
	session_start();
	if(!isset($_SESSION['user_id'])||$_SESSION['user_akses']!='user') header("location: login.php");
		include "koneksi.php";
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="tambah-mobil.php"><em class="fa fa-calendar">&nbsp;</em>Tambah Mobil</a></li>
