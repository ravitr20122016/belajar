...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="tambah-mobil.php"><em class="fa fa-calendar">&nbsp;</em>Tambah Mobil</a></li>
			<li><a href="charts.php"><em class="fa fa-bar-chart">&nbsp;</em> Charts</a></li>
			<li><a href="tambah-mobil.php"></a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-6">
				<h1 class="page-header">Tambahkan Kendaraan</h1>
			</div>
		</div><!--/.row-->
					...
					<div class="panel-body">
						<div class="col-md-12">
							<form role="form">
								...
								<div class="col-md-4">
								<label for="exampleFormControlFile1" style="padding-bottom:5%px;">Masukan Foto STNK</label>
    							...
    							<input type="file" class="form-control-file" id="exampleFormControlFile1">
										...
										<div class="col-md-6"><button type="button" class="btn btn-lg btn-primary ">Tambahkan Mobil</button></div>
